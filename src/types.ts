...
export interface Lead { id:string; company_name:string; website?:string; industry:string; location:string; estimated_employee_count?:number; contact_name?:string; designation?:string; email?:string; phone?:string; linkedin?:string; source:string; possible_hr_problem?:string; lead_score:number; status:LeadStatus; last_contact?:string; next_followup?:string; notes?:string; created_at:string; }
